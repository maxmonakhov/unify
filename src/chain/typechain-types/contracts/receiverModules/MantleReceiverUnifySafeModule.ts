...
export interface MantleReceiverUnifySafeModuleInterface
  extends utils.Interface {
  functions: {
    "mantleBridge()": FunctionFragment;
...
export interface MantleReceiverUnifySafeModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MantleReceiverUnifySafeModuleInterface;
  ...
  functions: {
    mantleBridge(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    mantleBridge(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    mantleBridge(overrides?: CallOverrides): Promise<PopulatedTransaction>;
